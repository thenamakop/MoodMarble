        ...
        >
          <View style={styles.heroSection}>
            ...
            <ThemedText themeColor="textSecondary" style={styles.subtitle}>
              Review this month at a glance. Each marked day reflects your
              dominant saved mood on this device only.
            </ThemedText>
          </View>
          ...
          {isLoading ? (
            ...
            >
                  ...
                  >
                    {week.map((cell, dayIndex) => (
                      <ThemedView
                        key={
                          cell.dateKey ??
                          `${month.monthKey}-blank-${weekIndex}-${dayIndex}`
                        }
                        type="background"
                        style={[
                          styles.dayCell,
                          {
                            borderColor: cell.isCurrentMonth
                        ...
                        testID={
                          cell.dateKey
                            ? `calendar-day-${cell.dateKey}`
                            : undefined
                        }
                      >
                        <ThemedText
                          themeColor={
                            cell.isCurrentMonth ? "text" : "textSecondary"
                          }
                          type="smallBold"
                        >
                          {cell.dayOfMonth ?? ""}
              ...
              {month.markedDayCount === 0 ? (
                ...
                >
                  No marbles saved this month yet. The calendar will light up as
                  you log a few private check-ins.
                </ThemedText>
                ...
                >
                  A few days are starting to appear. Keep going to build a
                  clearer monthly pattern.
                </ThemedText>
              ) : null}
            </ThemedView>
          )}
